...
public enum BlackstoneToolsBlocks {
    ...
    BlackstoneToolsBlocks(String id, Function<AbstractBlock.Settings, Block> block, AbstractBlock.Settings settings, ItemGroup group) {
        this.block = Registry.register(Registry.BLOCK, new Identifier(BlackstoneToolsMod.MODID, id), block.apply(settings));
        this.item = Registry.register(Registry.ITEM, new Identifier(BlackstoneToolsMod.MODID, id), new BlockItem(this.block, new Item.Settings().group(group)));
    }
